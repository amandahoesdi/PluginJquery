...
$(document).ready(function(){
    var options = {
        ...
        animationEasing: 'ease', //nilai yang diterima: linear ease in out in-out snap easeOutCubic
                                ...
                                //easeInOutQuart easeInQuint easeOutQuint easeInSine easeOutSIne
    ...
    $(".bahasa .negara").select2();
    $(".slide#satu").backstretch("./images/images1.jpg");
    $(".slide#dua").backstretch("./images/images2.jpg");
    $(".slide#tiga").backstretch("./images/images3.jpg");
    $(".slide#empat").backstretch("./images/images4.jpg");
    $(".slide#lima").backstretch("./images/images5.jpg");
    $(".slide#enam").backstretch("./images/images6.jpg");
    $(".slide#tujuh").backstretch();
